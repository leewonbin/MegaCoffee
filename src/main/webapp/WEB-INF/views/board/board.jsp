														...
														<div class="text_wrap">
															<div class="text">
																<a href="detail/?bbs_idx=181&amp;bbs_category=4&amp;bbs_page=1">
																	<em>
																		[고객센터] 9월 1일부터 인상되는 디저트 가격이 어떻게 되나요?					<!-- 내용 -->												
																	</em>
																</a>
															</div>
														</div>
													</td>
													<td class="board_pc"> 메가MGC커피</td> <!-- 작성자 -->
													<td>2022-08-30</td> <!-- 업로드 날짜 -->
													<td class="board_pc">1215</td> <!-- 조회수 -->
												</tr>
												<tr>
															<td class="board_pc">37</td> <!-- 작성자 -->
															<td>
																<div class="text_wrap">
																	<div class="text">
																		<a href="detail/?bbs_idx=177&amp;bbs_category=4&amp;bbs_detail_category=&amp;bbs_page=1">
																			<em>
																				[고객센터] 고객센터 운영시간이 어떻게 되나요?																			
																			</em>
																		</a>
																	</div>
																</div>
																...
																<div class="text_wrap">
																	<div class="text">
																		<a href="detail/?bbs_idx=170&amp;bbs_category=4&amp;bbs_detail_category=&amp;bbs_page=1">
																			<em>
																				[무료쿠폰] 스탬프 쿠폰이 발급 되지 않는데 확인 가능한가요?																			
																			</em>
																		</a>
																	</div>
																</div>
