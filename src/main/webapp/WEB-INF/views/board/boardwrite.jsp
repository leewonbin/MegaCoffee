...
<html lang="ko"><head><style type="text/css">@charset "UTF-8";[ng\:cloak],[ng-cloak],[data-ng-cloak],[x-ng-cloak],.ng-cloak,.x-ng-cloak,.ng-hide:not(.ng-hide-animate){display:none !important;}ng\:form{display:block;}</style>
	...
	<meta name="Subject" content="메가커피 커피전문점, 프랜차이즈, 메가엠지씨커피, 빅사이즈 투샷, 가맹안내, 테이크아웃">
	<meta name="keywords" content="메가커피 커피전문점, 프랜차이즈, 메가엠지씨커피, 빅사이즈 투샷, 가맹안내, 테이크아웃">
	<meta name="Descript-xion" content="메가커피 커피전문점, 프랜차이즈, 메가엠지씨커피, 빅사이즈 투샷, 가맹안내, 테이크아웃">
	<meta name="Description" content="메가커피 커피전문점, 프랜차이즈, 메가엠지씨커피, 빅사이즈 투샷, 가맹안내, 테이크아웃">
	...
	<!-- naver start -->
	<meta name="naver-site-verification" content="855dc64a4a2ca80c4cb373c1b30a054d1807804e">
	<!-- naver end -->
	<!-- webmaster start -->
	<meta property="og:type" content="website">
	<meta property="og:title" content="메가MGC커피">
	<meta property="og:site_name" content="메가커피 커피전문점, 프랜차이즈, 메가엠지씨커피, 빅사이즈 투샷, 가맹안내, 테이크아웃">
	<meta property="og:description" content="메가커피 커피전문점, 프랜차이즈, 메가엠지씨커피, 빅사이즈 투샷, 가맹안내, 테이크아웃">
...
오픈										</div>
				...
				<div class="table0">
					<div class="cell">
						<div class="nav_quick_title">
							<img src="https://img.79plus.co.kr/megahp/common/img/quick_img.png?ver=202403041117" alt="">
							<div class="cont_text_inner robo">
								QUICK
							</div>
						</div>
						<div class="nav_quick_close">
						</div>
					</div>
				</div>
			</button>
		...
		<div class="head_wrap head_fixed">
			<div class="head">
				<div class="head_logo">
					<a href="/">
						<img src="https://img.79plus.co.kr/megahp/common/img/logo.png" class="head_logo_img_fixed">
						<img src="https://img.79plus.co.kr/megahp/common/img/logo_b.png" class="head_logo_img">
					</a>
				</div>
...
<script src="./js/certified2.js?v=202404251519"></script>
				...
				<div class="cont_boxs">
					<div class="db">							
								...
								<a href="/bbs/?bbs_category=4">
									<div class="input_width">
										<div class="input_btn_wrap input_wrap2">
											<input type="button" value="FAQ 바로가기" class="btn btn1 btn_ani" id="">
										</div>
									</div>
								</a>
							</div>
						...
						<form name="submit_form" id="submit_form" method="post" enctype="multipart/form-data">
							<input type="hidden" name="customer_category" id="customer_category" value="3">
							<input type="hidden" name="customer_tbl_area1_erp" id="customer_tbl_area1_erp" value="">
							<input type="hidden" name="customer_tbl_area2_erp" id="customer_tbl_area2_erp" value="">
							<input type="hidden" name="customer_tbl_price_erp" id="customer_tbl_price_erp" value="">
							<input type="hidden" name="customer_tbl_category_erp" id="customer_tbl_category_erp" value="">
							<input type="hidden" name="customer_tbl_store_erp" id="customer_tbl_store_erp" value="">
							<input type="hidden" name="customer_tbl_email_code" id="customer_tbl_email_code" value="">
							<div class="cont_text_wrap">
											...
											<tr>
												...
												<td>
													<div class="input_text_wrap input_wrap2">
														<label>
															<input type="text" name="title" id="customer_tbl_title" required="required" oninput="decodeHTMLEntities(this.value,this)">
															<span>제목을 입력하세요</span>
														</label>
													</div>
												</td>
												...
												<td>
													<div class="cont_text">
														<div class="input_textarea_wrap">
															<label>
																<textarea name="content" id="customer_tbl_content" class="count_input" oninput="decodeHTMLEntities(this.value,this)"></textarea>
															</label>
														</div>
														<div class="input_text_info cont_text_info input_limit_byte">
															<span class="count">0</span>/<span class="maxcount">3900</span>byte(한글 1300자, 영어 4000자)
														</div>
													</div>
												</td>	 
											</tr>											
							  ...
							  <div class="cont_text_wrap">								
								<div class="cont_text">
									<div class="input_btn_wrap input_wrap2">
										<input type="button" value="접수하기" class="btn btn1 btn_ani" id="submit">
									</div>
								</div>
							</div>
						</form>
	...
	<script type="text/javascript">
		$(document).on("change","#customer_tbl_area1",function(){
			var area_sido = $("select[name='customer_tbl_area1'] option:selected").val();
			search = location.search
			var params = new URLSearchParams(search);
			var db_category = params.get('db_category');
			$.ajax({
				url : "area_search.php?area_sido="+area_sido+"&db_category="+db_category,
				type : "GET",
		...
		$(document).on("change","#customer_tbl_menu1",function(){
			var menu_category = $("select[name='customer_tbl_menu1'] option:selected").val();
			$.ajax({
				url : "menu_search1.php?menu_category="+menu_category,
				type : "GET",
				success : function(result) {
					$("#customer_tbl_menu2").html(result);

					var menu_category2 = $("select[name='customer_tbl_menu2'] option:selected").val();
					$.ajax({
						url : "menu_search2.php?menu_category="+menu_category2,
						type : "GET",
						success : function(result) {
		...
		$(document).on("change","#customer_tbl_menu2",function(){
			var menu_category = $("select[name='customer_tbl_menu2'] option:selected").val();
			$.ajax({
				url : "menu_search2.php?menu_category="+menu_category,
				type : "GET",
				success : function(result) {
					$("#customer_tbl_menu").html(result);
				}
		...
		$(document).on("click","#submit",function(e) {		
			...
			if ( db_category == '7' ) {
				var customer_tbl_price = uncomma($("#customer_tbl_price").val());
				console.log(customer_tbl_price)
				formdata.append("customer_tbl_price",customer_tbl_price);
			}
							...
							<div class="cont_text">
								<div class="cont_list cont_list_m cont_list_m1">
									<ul>
										...
										<li>
											<div class="foot_sns">
												<div class="cont_list cont_list3 cont_list_small cont_list_width">
													<ul>
														<li>
															<a href="https://blog.naver.com/ekddusekddus" target="_blank">
																<img src="https://img.79plus.co.kr/megahp/common/img/sns/sns_blog.png">
									...
									<li>
										...
										<div class="cont_text">
											<div class="cont_list cont_list1 cont_list_small cont_list_small1">
												<ul>
													<li>
														<a href="/customer/?db_category=3">
															상품제안
														</a>
													</li>
													<li>
														<a href="/customer/?db_category=5">
															마케팅 제휴
														</a>
													</li>
												</ul>
	...
	<!-- e: 사이트 연관 채널 마크업 -->
	<script type="text/javascript" src="/common/js/daterangepicker_common.js"></script>
