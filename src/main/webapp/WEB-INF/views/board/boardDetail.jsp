...
<body data-aos-easing="ease" data-aos-duration="1200" data-aos-delay="0">
							...
							<div class="board_detail">
									...
									<div class="board_detail_title_info">
										<div class="float_right">
											<span> 구분 ${boardDetail.separation} </span> <span> 작성자
												${boardDetail.writer} </span> <span>
												${boardDetail.upload_at} </span> <span> ${boardDetail.hits}
											</span>
										</div>
									</div>
								</div>
								...
								<div class="board_detail_prev_next">
									<ul class="prev-next-box">
										<li><span>다음글</span> <span> <a
												href="../detail/?bbs_idx=181&amp;bbs_category=4&amp;bbs_detail_category=&amp;bbs_page=1">
													[고객센터] 9월 1일부터 인상되는 디저트 가격이 어떻게 되나요? </a>
										</span></li>
										<li><span>이전글</span> <span> <a
												href="../detail/?bbs_idx=176&amp;bbs_category=4&amp;bbs_detail_category=&amp;bbs_page=1">
	...
	<script>
		const categoryCode = "${boardDetail.category_id}";
		...
		goToListBtn.addEventListener("click", ()=>{
		    ...
		    let cp;
		    if(params.get("CATEGORY_ID") != ""){ // 쿼리스트링에 cp가 있을 경우
		    	console.log(cp)
		        cp = "?CATEGORY_ID=" + params.get("CATEGORY_ID");
		    console.log("aa",cp)
		    }else{
		        cp = "";
		    }
