								...
								<ul>
									<li>
										<div class="cont_title_wrap">
											...
											<div class="cont_title">
												<h3>
													<span class="inline"><b>빨간 코 루돌프의<br>MEGA CHRISTMAS TO YOU
													</b></span>
												</h3>
											</div>
										</div>
										<div class="cont_text_wrap">
											...
											<div class="cont_text">
												MGC에서 준비한 즐거움 가-득 메가 크리스마스 파티에 초대합니다!<br>루돌프를 닮은 상큼한 리치티와 매콤한 떡볶이까지<br>
												가까운 메가MGC커피에서 크리스마스를 즐겨보세요.
											</div>
										</div>
									</li>
									<li><img src="/img/푸드.jpg">
									</li>
								</ul>
							</div>
						</div>
