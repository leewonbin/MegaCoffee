(function(a,b) {
	if(typeof define==="function"&&define.amd) {
		...
		if(typeof exports!=="undefined") {
			...
			a.daterangepicker=b(a, {
			}
			,a.moment||moment,(a.jQuery||a.Zepto||a.ender||a.$))
		}
	}
}
(this|| {
...
,function(b,c,e,d) {
	var a=function(m,s,k) {
		...
		this.locale= {
			format:"MM/DD/YYYY",separator:" - ",applyLabel:"적용",cancelLabel:"Cancel",weekLabel:"W",customRangeLabel:"Custom Range",daysOfWeek:e.weekdaysMin(),monthNames:e.monthsShort(),firstDay:e.localeData().firstDayOfWeek()
		}
		;
		...
		if(typeof s.template!=="string") {
			s.template='<div class="daterangepicker dropdown-menu"><div class="calendar left"><div class="daterangepicker_input"><div class="input_text_wrap input_wrap2"><label><input class="input-mini" type="text" name="daterangepicker_start" value="" /></label></div><div class="calendar-time"><div></div></div></div><div class="calendar-table"></div></div><div class="calendar right"><div class="daterangepicker_input"><div class="input_text_wrap input_wrap2"><label><input class="input-mini" type="text" name="daterangepicker_end" value="" /></label></div><div class="calendar-time"><div></div></div></div><div class="calendar-table"></div></div><div class="ranges list_button list_button_check"><div class="range_inputs"><div class="input_btn_wrap input_wrap2"><button class="applyBtn btn btn1" disabled="disabled" type="button"></button></div></div></div></div>'
		}
		...
		if(typeof s.ranges==="object") {
			...
			for (p in this.ranges) {
				q+="<li><button class='btn search_datepicker_btn search_datepicker_btn_today'>"+p+"</button></li>"
		...
		if(this.element.is("input")) {
			this.element.on( {
				"click.daterangepicker":d.proxy(this.show,this),"focus.daterangepicker":d.proxy(this.show,this),"keyup.daterangepicker":d.proxy(this.elementChanged,this),"keydown.daterangepicker":d.proxy(this.keydown,this)
			}
			)
		} else {
	...
	a.prototype= {
		...
		,renderCalendar:function(A) {
			...
			if((!j||j.isBefore(P.firstDay))&&(!this.linkedCalendars||A=="left")) {
				H+='<th class="prev available"></th>'
			} else {
				H+="<th></th>"
			}
			var M=P[1][1].format("YYYY ") + "<div>" + this.locale.monthNames[P[1][1].month()] + "</div>";
		...
		,move:function() {
			...
			if(this.opens=="left") {
				this.container.css( {
					top:h,right:g-this.element.offset().left-this.element.outerWidth(),left:"auto"
				}
				);
				...
				if(this.opens=="center") {
					this.container.css( {
						top:h,left:this.element.offset().left-f.left+this.element.outerWidth()/2-this.container.outerWidth()/2,right:"auto"
					}
					);
					if(this.container.offset().left<0) {
						this.container.css( {
					...
					this.container.css( {
						top:h,left:this.element.offset().left-f.left,right:"auto"
					}
					);
